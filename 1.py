...
def main():
    ...
    img_corazon = ImageTk.PhotoImage(Image.open('corazon.png'))
    img_roto = ImageTk.PhotoImage(Image.open('roto.jpg'))
    img_amistad = ImageTk.PhotoImage(Image.open('amistad.png'))
    img_interrogante = ImageTk.PhotoImage(Image.open('interrogante.png'))
