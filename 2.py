...
def main():
    ...
    img1 = ImageTk.PhotoImage(Image.open('dado1.png'))
    img2 = ImageTk.PhotoImage(Image.open('dado2.png'))
    img3 = ImageTk.PhotoImage(Image.open('dado3.png'))
    img4 = ImageTk.PhotoImage(Image.open('dado4.png'))
    img5 = ImageTk.PhotoImage(Image.open('dado5.png'))
    img6 = ImageTk.PhotoImage(Image.open('dado6.png'))
